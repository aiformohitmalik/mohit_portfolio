...
export const GroundReboticsPage = ({ onNavigate }) => {
  ...
  return (
    <PageLayout title="The Founder Years">
      ...
      <section className="subpage-section container">
        <div className="subpage-grid-2">
          <div>
            ...
            <p className="about-paragraph" style={{ fontSize: '15px' }}>{data.contextParagraph}</p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '16px' }}>
            <div className="badge-solid badge-amber" style={{ padding: '24px', borderRadius: '10px' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>
                Incubated inside the <strong>Atal Incubation Centre (AIC) at IIT Delhi</strong>, the venture was evaluated and vetted under strict regulatory processes to secure public capital.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="subpage-section container">
        ...
        <div style={{ overflowX: 'auto' }}>
          <table className="rec-table">
            <thead>
              <tr>
                <th className="rec-cell rec-cell-prize">Prize</th>
                <th className="rec-cell rec-cell-event">Event</th>
                <th className="rec-cell rec-cell-venue">Venue</th>
                <th className="rec-cell rec-cell-date">Date</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="subpage-grid-2">
          {data.projects.map((proj, i) => (
            <div key={i} className="op-card" style={{ borderLeft: '3px solid var(--blue-primary)' }}>
              ...
              <span className="badge-solid badge-blue" style={{ display: 'inline-block', marginBottom: '12px' }}>{proj.funding}</span>
      ...
      <section className="subpage-section container">
        <div className="subpage-grid-2">
          <div>
            <SectionHeading num="05" title={data.additiveMfg.title} />
            <p className="about-paragraph" style={{ fontSize: '14px', lineHeight: 1.7 }}>{data.additiveMfg.desc}</p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', justifyContent: 'center' }}>
            <div className="badge-solid badge-gray" style={{ padding: '16px' }}>
              <span className="mono-text" style={{ color: 'var(--amber-primary)', fontWeight: 600, display: 'block', marginBottom: '4px' }}>MATERIALS EVALUATED</span>
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>PLA, Tough PLA, TPU 95A, ABS, SLA Resins, SLS Powders (50+ total)</span>
            </div>
            <div className="badge-solid badge-gray" style={{ padding: '16px' }}>
              <span className="mono-text" style={{ color: 'var(--blue-primary)', fontWeight: 600, display: 'block', marginBottom: '4px' }}>EQUIPMENT STANDARD</span>
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Ultimaker S5 High-Precision Fused Deposition Modeling (FDM)</span>
            </div>
          </div>
        </div>
      </section>
